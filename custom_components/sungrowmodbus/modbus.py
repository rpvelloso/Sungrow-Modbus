...
from SungrowModbusTcpClient.SungrowModbusTcpClient import AsyncSungrowModbusTcpClient
...
class ModbusHub:
    ...
    def __init__(self, hass: HomeAssistant, client_config: dict[str, Any]) -> None:
        ...
        self._client: (
            AsyncSungrowModbusTcpClient| None
        ) = None
        ...
        self._pb_class = AsyncSungrowModbusTcpClient
        self._pb_params = {
